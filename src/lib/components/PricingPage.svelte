...
<div class="pricing-page">
  ...
  <div class="action-buttons-grid">
    ...
    <button class="action-btn share-btn whatsapp full-width" on:click={handleShareWhatsApp} disabled={cost <= 0}>💬 WhatsApp</button>
  </div>
</div>
...
<style>
  ...
  .action-buttons-grid { display: flex; flex-direction: column; gap: 0.6rem; margin-top: 1rem; margin-bottom: 1rem; }
  .action-btn { 
    display: flex; align-items: center; justify-content: center; gap: 0.4rem;
    min-height: 52px; border-radius: 12px; font-weight: 700; font-size: 0.9rem;
